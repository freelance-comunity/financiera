  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box box-default">
        ...
        <div class="row invoice-info">
          <div class="col-sm-4 invoice-col">
            <address>
              <strong>Fecha de solicitud: {{ $credits->date}}</strong><br>
            </address>
          </div>
          <!-- /.col -->
          <div class="col-sm-4 invoice-col">
      ...
      <div class="row">
        ...
        <!-- accepted payments column -->
        <div class="col-xs-6">
          <p class="lead">Atención en: {{$credits->requested}}</p>         
        </div>
        <!-- accepted payments column -->
        <div class="col-xs-6">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <!--<a href="{{ url('moratorio-pdf') }}/{{$credits->id}}" class="btn btn-default"><i class="fa fa-file-pdf-o"></i> Moratorio</a>-->
        </div>
      </div>
    </div>
  </div>
