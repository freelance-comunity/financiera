...
<head>
  ...
  <title>s&c Empresarial datos de acceso</title>
  <style type="text/css">
                ...
                <tr>
                  <td valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" height="303">
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                      <tr>
                        <td>
                          <h1>BIENVENIDO AL SISTEMA S&C EMPRESARIAL</h1><br>
                          <h2>Para acceder al sistema da Click en el boton.</h2>
                          <br>
                        </td>
                      </tr>
                    </table>
                    ...
                    <td class="hide reveal">
                      ...
                      <td style="width:150px; height:33px; background-color: #3bcdc3;" >
                        <div>
                          <a href="#" style="background-color:#3bcdc3;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Entrar</a>
                          </div>
                      </td>
                      <td>
                        &nbsp;
                ...
                <td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                        Para cualquier duda estamos para ayudarte <a style="color: #2BB6AC;" href="#">contactanos</a>.
                      <br>
                      <br>
                      s&c Empresarial
                      <br>
